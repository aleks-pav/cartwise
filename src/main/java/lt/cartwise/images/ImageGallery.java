...
@Entity
@Table(name = "image_galleries", indexes = {
		@Index(name = "galleries_lookup", columnList = "imageableId, imageableType") }, uniqueConstraints = {
				@UniqueConstraint(name = "galleries_unique", columnNames = { "imageableId", "imageableType",
						"fieldName" }) })
